<!--
  File Name: viewRosterByDate.php
  Created by: Aidan McCarthy
  Project: Rostering Online Management System
  The webpage for viewing rosters of a certain date
-->
<?php

session_start();//start session
$rosterLocationID = $_GET['rosterLocationID'];//set session variable
?>
...
$appQuery = array('weekDay' => $rosterLocationID);//query to compare

$cursor = $collection->find($appQuery);//result of query
?>
...
<body>
    <?php include '../common.php';?><!-- include common.php-->
     <?php while ($cursor->hasNext())://loop through cursor and display the inforamtion of the object.
