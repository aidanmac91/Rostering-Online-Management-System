<!--
  File Name: viewRosterByStaffMember.php
  Created by: Aidan McCarthy
  Project: Rostering Online Management System
  The webpage for viewing rosters for a staff member
-->
<?php

session_start();//start session
$rosterStaffID = $_GET['rosterStaffID'];//set session variable
...
$appQuery = array('staffMember' => $rosterStaffID);//query to be compared

$cursor = $collection->find($appQuery);//result of teh query
?>
